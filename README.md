...
<div align="center">
  <img src="https://komarev.com/ghpvc/?username=Jack5336&style=for-the-badge&color=0e75b6" alt="Profile views"/>
</div>
...
> *"Advanced technology in service of a meaningful life."*

I'm a CS graduate student at **UCL** passionate about building systems that amplify human intelligence. As a **PKM enthusiast**, I've explored Notion, Flomo, Obsidian, Logseq, and Tana — building my own *Personal AI Infrastructure* to compound knowledge over time. My intellectual diet spans **Philosophy**, software architecture, and the hardware/software interface.

```python
jiawei = {
    "currently":    "MSc Computer Science @ UCL",
    "building":     "Personal AI Infrastructure (PAI)",
    "reading":      ["Philosophy of Mind", "Systems Thinking"],
    "tools":        ["Obsidian", "Claude Code", "Python"],
    "languages":    ["English", "Mandarin"],
    "ask_me_about": ["PKM", "AI agents", "Hardware design"],
}
```
...
| ---- | ---------------------------------------------------- | ----------------------------------- | --------------------- |
| 🎓    | **MSc Computer Science**                             | University College London (UCL)     | Sept 2024 – Sept 2025 |
| 🎓    | **BEng Electronic Science & Technology** · `GPA 3.7` | Xi'an Jiaotong-Liverpool University | Sept 2020 – Aug 2024  |
...
<details>
<summary><strong>🔧 Hardware Engineer</strong> &nbsp;·&nbsp; Jun 2023 – Sept 2023</summary>
<br/>
...
<details>
<summary><strong>🔬 Research Assistant</strong> &nbsp;·&nbsp; Jun 2021 – Aug 2021 &nbsp;·&nbsp; <em>Supervisor: Prof. Sang Lam</em></summary>
<br/>
...
- Presented findings through posters and academic presentations
...
| 🏅 Mathematical Contest in Modeling — H Award | Mar 2022 |
...
- **🤖 AI Agents & LLM Infrastructure** — building autonomous workflows with Claude & DeepSeek
- **🧩 Personal Knowledge Management** — Obsidian-based second brain + spaced repetition
- **📖 Philosophy of Mind** — consciousness, epistemology, personal identity
- **🔄 Systems Thinking** — emergence, feedback loops, complex adaptive systems
